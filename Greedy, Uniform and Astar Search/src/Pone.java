...
public class Pone {
	...
	try {
		...
		= new UniformCostSearch(graph, 
					initialLoc, destinationLoc, limit);
	    ...
	    GreedySearch gs 
		= new GreedySearch(graph, initialLoc, destinationLoc, limit);
	    ...
	    AStarSearch as 
		= new AStarSearch(graph, initialLoc, destinationLoc, limit);
